...
const ReceiptPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#f2f2f2] gap-1 text-black w-full">
            <NavbarPayment title="Receipt" route="/home" />
            <div className="flex flex-col justify-center items-center p-4">
                <div className="bg-white shadow-md p-4 rounded-lg w-full flex flex-col items-center">
                    ...
                    <div className="flex flex-col gap-2 w-full mt-4">
                        ...
                        <div className="flex justify-between items-center">
                            <span>Total</span>
                            <span className="font-semibold">Rp. {dataTransaction?.grand_total.toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between items-center">
                            <span>Dibayar</span>
                            <span className="font-semibold">
                                Rp. {dataTransaction?.pay_amount ? Number(dataTransaction.pay_amount).toLocaleString() : '0'}
                            </span>
                        </div>
                        <div className="flex justify-between items-center">
                            <span>Kembalian</span>
                            <span className="font-semibold">Rp. {dataTransaction ? (dataTransaction.pay_amount - dataTransaction.grand_total).toLocaleString() : "0"}</span>
                        </div>
                    </div>
                </div>
