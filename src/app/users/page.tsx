        ...
        <div className="min-h-screen bg-[#f2f2f2] flex flex-col gap-1 text-black">
            ...
            <div className="flex flex-col gap-4 pr-4 pl-4 mt-2">
                <div className="p-4 border border-black rounded-lg flex justify-between items-center">
                    <span className="font-semibold">Owner | role</span>
                        ...
                        <>
                            ...
                            <ModalBody>
                                <div className="flex flex-col gap-2">
                                    ...
                                    <Input type="text" variant="bordered" className="text-black" placeholder="John Doe" />
                                </div>
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="" className="text-black">Email</label>
                                    <Input type="email" variant="bordered" className="text-black" placeholder="Johndoe@gmail.com" />
                                </div>
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="" className="text-black">Password</label>
                                    <Input type="password" variant="bordered" className="text-black" placeholder="password" />
                                </div>
                            </ModalBody>
                            <ModalFooter>
